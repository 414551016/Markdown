...
- {New Codex}
  ...
  - [ChatGPT Work 完整教學｜目標模式/規劃模式+Sites 互動網站！大量名片歸檔、比價報告與互動網站實測(19:36)](https://www.youtube.com/watch?v=WnzM4ir4AWk)
    ...
    > 請綜合三家旅行社報價、問卷CSV與公司福委會規範，分析最符合員工喜好與預算的方案。
...
| 符號  | 主要用途             | 簡單理解       |
| --- | ---------------- | ---------- |
| `/` | 呼叫 Codex 功能指令    | 命令選單<br>MCP、任務、初始化、回饋、寵物、專案、快速、推理、模型、狀態、目標、規劃模式、記憶<br>技能...       |
| `@` | 指定檔案或資料夾作為上下文    | 「請看這個檔案」<br>檔案和資料夾、目標(設定要持續追求的目標)、規劃模式(開啟規劃模式)<br>外掛程式...、應用程式、ChatGPT對話...、檔案和任務、輸人以搜尋檔案或任務   |
| `$` | 明確呼叫 Skill 或 App | 「使用這個專業流程」 |
