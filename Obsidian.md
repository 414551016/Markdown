...
- {[灵姐说AI](https://www.youtube.com/@aihublab)}
...
> 而 Obsidian 則允許你把筆記互相連結：當你輸入 [[筆記名稱]] 時（左右個二個[ 中括符號），Obsidian 會自動建立連結「關聯圖檢視」。
> ```
> DQN 是一種 [[強化學習]] 演算法。 DQN → 強化學習
